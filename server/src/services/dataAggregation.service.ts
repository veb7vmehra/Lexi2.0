...
const messagesSheetCol = [
    ...
    { header: 'Valence_mean', key: 'valence_mean' },
    { header: 'Arousal_mean', key: 'arousal_mean' },
    { header: 'Valence_max', key: 'valence_max' },
    { header: 'Arousal_max', key: 'arousal_max' },
    { header: 'Valence_min', key: 'valence_min' },
    { header: 'Arousal_min', key: 'arousal_min' },
    { header: 'Created At', key: 'createdAt' },
];
                ...
                user.conversations.forEach((conversation) => {
                    ...
                    conversation.conversation.forEach((message) => {
                        messagesSheet.addRow({
                            ...
                            valence_mean: message.valence[0],
                            arousal_mean: message.arousal[0],
                            valence_max: message.valence[1],
                            arousal_max: message.arousal[1],
                            valence_min: message.valence[2],
                            arousal_min: message.arousal[2],
                            role: message.role,
